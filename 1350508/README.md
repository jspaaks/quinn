...
$ cmake --build .
$ cmake --install . --prefix dist
$ mpirun -np 0 ./dist/bin/sieve 100000000
5761455 primes are less than or equal to 100000000
Total elapsed time:   0.040217
```
